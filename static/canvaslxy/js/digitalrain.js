...
$packages["main"] = (function() {
	...
	main = function() {
		...
		$global.addEventListener($externalize("load", $String), $externalize((function $b() {
			...
			rain1 = [rain1];
			rain2 = [rain2];
			lowGlyphCanvases = new sliceType([NewGlyphCanvas("#6ba5b8"), NewGlyphCanvas("#85D7EC")]);
			highGlyphCanvases = new sliceType([NewGlyphCanvas("#5b95a8"), NewGlyphCanvas("#85D7EC")]);
	...
	DigitalRain.ptr.prototype.loop = function(timestamp) {
		...
		while (true) {
			...
			drop.row = drop.row + ((elapsed) / 3 * drop.speed);
	...
	NewGlyphCanvas = function(color) {
		...
		col = 0;
		row = 1;
		_ref = "010101011011011001010101101101";
		_i = 0;
		while (true) {
			if (!(_i < _ref.length)) { break; }
